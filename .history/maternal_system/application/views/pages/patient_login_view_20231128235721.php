        ...
        <div class="row justify-content-center" style="width: 70%;">
          <div class="col-md-8 col-lg-6 col-xxl-3">
            <div class="card custom-border rounded-5">
              <div class="card-body">
                <a href="../home/login" class="text-nowrap logo-img text-center d-block py-3 w-100">
            ...
            ?>
                ...
                <form action="../patient/checkuser" method="POST">
                  <div class="mb-3">
                  ...
                  <div class="d-flex justify-content-center align-items-center">
                    <button type="submit" class="btn btn-bg-card w-50 py-8 fs-4 mb-3 rounded-5 btn-custom-border">LOGIN</a>
                  </div>
                  <div class="d-flex justify-content-center align-items-center">
                    Doesn't have and account yet? <a href="#"> here.</a>
                  </div>
                </form>
              </div>
            </div>
