...
<div class="alert alert-success" role="alert" id="successAlert">
  <strong><i class="fas fa-check-circle"></i> Success! </strong> Welcome Encoder...
</div>
...
<script>
  ...
  <h4 class="pb-2"><b>Encoder Dashboard</b></h4>
        <!--  Row 1 -->
        <div class="row">
          <div class="col-lg-4">
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="card overflow-hidden">
                  <div class="card-body p-4 bg-card-2">
                    <h5 class="card-title mb-9 fw-semibold">Blank</h5>
